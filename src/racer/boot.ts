 ...
 */
export async function bootRacer(host: HTMLElement): Promise<RacingGame> {
	...
	gamePromise = (async () => {
		...
		// /racer/<seed>?… boots straight into that exact race
...
export async function disposeRacer(): Promise<void> {
