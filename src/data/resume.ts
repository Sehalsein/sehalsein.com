export const RESUME_DATA = {
  ...
  summary: `Fullstack Engineer with 6 years of experience in developing scalable applications using
 NodeJS and ReactJS, enhancing user engagement and system performance. Proficient
 in managing cloud infrastructure with AWS and Google Cloud Platform, ensuring
 seamless deployment and reliability for high-traffic platforms`,
  skills: [
    { title: "NextJS", icon: "" },
    { title: "NodeJS", icon: "" },
    { title: "ReactJS", icon: "" },
  ...
  experience: [
    {
      ...
      description: [
        ...
        "OverseeCI/CD and cloud infrastructure using Docker, GitHub Actions, AWS, and GCP for seamless deployment.",
    ...
    },
    {
      ...
      description: [
        ...
        "Optimize backend servers for improved performance, scaling to handle 150,000 concurrent users.",
        "Create localization tools supporting multiple languages, enhancing global reach.",
        "Enhanceanalytics tools to capture extensive data, driving informed decision-making.",
      ],
    },
    {
      company: "DataGPT",
