...
export class VisualVehicle
{
    ...
    setPaints()
    {
        ...
        // stored so destroy() can unsubscribe — otherwise a swapped-out vehicle
        // keeps reacting to reward changes and fights the player's paint choice
