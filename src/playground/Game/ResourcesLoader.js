...
// Under Next, engine assets are served statically from /public/playground-assets.
export const ASSET_BASE = '/playground-assets/'
...
export class ResourcesLoader
{
    ...
    getLoader(_type)
    {
        ...
        else if(_type === 'textureKtx')
        {
            ...
            loader.setTranscoderPath(`${ASSET_BASE}basis/`)
            loader.detectSupport(this.game.rendering.renderer)
        }
        else if(_type === 'draco')
        {
            loader = new DRACOLoader()
            loader.setDecoderPath(`${ASSET_BASE}draco/`)
            loader.preload()
        }
        else if(_type === 'gltf')
        {
